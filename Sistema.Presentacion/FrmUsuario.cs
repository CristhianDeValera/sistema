...
namespace Sistema.Presentacion
{
    public partial class FrmUsuario : MetroFramework.Forms.MetroForm
    {
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            ...
            {
                string Rpta = "";
                if (TxtId.Text == string.Empty || CboRol.Text == string.Empty || TxtNombre.Text.Trim() == string.Empty || TxtEmail.Text.Trim() == string.Empty)
                {
        ...
        private void BtnInsertar_Click(object sender, EventArgs e)
        {
            ...
            {
                string Rpta = "";
                if (CboRol.Text == string.Empty || TxtNombre.Text.Trim() == string.Empty || TxtEmail.Text.Trim() == string.Empty || TxtClave.Text.Trim() == string.Empty)
                {
                    this.MensajeError("Falta ingresar algunos datos, serán remarcados.");
                    ErrorIcono.SetError(CboRol, "Seleccione un Rol");
                    ErrorIcono.SetError(TxtNombre, "Ingrese un nombre");
